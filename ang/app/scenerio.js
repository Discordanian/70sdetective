...
Scenerio = function() {
    ...
    return {
        ...
        spam: function() {
            ...
            console.log({dump: population} , "Population");
            console.log({dump : populationMap}, 'Population Map');
            console.log({dump : answers} , 'Answers');
        ...
        getSuspectAlibi: function(suspectID) {
            ...
            if (killerID === 0) {
                ...
                console.log("Accessing getSuspectAlibi before init so returning an empty string.");
                return "";
            }
            if (suspectID === victimID) { 
                return deadMessage;
